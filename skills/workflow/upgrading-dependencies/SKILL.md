...
description: Use when the user wants to audit, plan, upgrade, pin, or verify project dependencies, package manifests, lockfiles, runtime environments, framework versions, security patches, or dependency drift across package managers.
---
...
Run the smallest meaningful baseline before changing the dependency when practical:
